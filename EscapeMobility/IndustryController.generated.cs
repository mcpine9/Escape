...
namespace EscapeMobility.Controllers
{
    public partial class IndustryController
    {
        ...
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "Industry";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "Industry";
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_IndustryController : EscapeMobility.Controllers.IndustryController
    {
        public T4MVC_IndustryController() : base(Dummy.Instance) { }
